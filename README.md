...
4. Configure le fichier .env.local
    ...
    - URL de base du projet : DEFAULT_URI=http://localhost
    - Base de données SQL : DATABASE_URL="mysql://:@:/?serverVersion=8.0"
    - Serveur SMTP pour l'envoi d'emails : MAILER_DSN="smtp://:@:?encryption=<ssl/tls>&auth_mode=login"
    - Base de données MongoDB : MONGODB_URL="mongodb://:@:"
